...
export const ACHIEVEMENT_CATEGORIES = [
  { key: 'progreso', label: 'Progreso', icon: '📈', color: '#22c55e' },
  { key: 'reputacion', label: 'Reputacion', icon: '🛡️', color: '#3b82f6' },
  { key: 'coleccion', label: 'Coleccion', icon: '📚', color: '#8b5cf6' },
  { key: 'comunidad', label: 'Comunidad', icon: '🌐', color: '#f59e0b' },
  { key: 'growth', label: 'Growth', icon: '🚀', color: '#ea580c' },
  { key: 'impacto', label: 'Impacto', icon: '💥', color: '#ec4899' },
  { key: 'curacion', label: 'Curación', icon: '🧹', color: '#06b6d4' },
  { key: 'partner', label: 'Partner / Validación', icon: '✔️', color: '#14b8a6' },
]
...
export const BADGES = {
  activo: { name: 'Activo', icon: '⚡', iconKey: 'BadgeActiveIcon', color: '#22c55e', description: 'Sostiene actividad util.' },
  confiable: { name: 'Confiable', icon: '🛡️', iconKey: 'BadgeTrustedIcon', color: '#3b82f6', description: 'Cierra bien y sostiene confianza.' },
  buen_cruce: { name: 'Buen cruce', icon: '🤝', iconKey: 'BadgeActiveIcon', color: '#8b5cf6', description: 'Genera intercambios reales.' },
  top_cruce: { name: 'Top cruce', icon: '🏆', iconKey: 'BadgeTopTradeIcon', color: '#f59e0b', description: 'Impacta fuerte en ranking y liquidez.' },
  motor_de_red: { name: 'Motor de red', icon: '📈', iconKey: 'BadgeImpactHighIcon', color: '#ea580c', description: 'Activa comunidad y crecimiento.' },
  curador: { name: 'Curador', icon: '🧠', iconKey: 'BadgeTrustedIcon', color: '#14b8a6', description: 'Aporta validacion util al sistema.' },
  partner_verificado: { name: 'Partner verificado', icon: '✔️', iconKey: 'BadgePartnerVerifiedIcon', color: '#14b8a6', description: 'Validado en circuito PartnerStore.' },
  desde_el_comienzo: { name: 'Desde el comienzo', icon: '🌅', iconKey: 'FoundingMemberIcon', color: '#64748b', description: 'Presente en las primeras etapas.', rarity: 'histórico' },
  curador_v2: { name: 'Curador', icon: '🧠', iconKey: 'BadgeTrustedIcon', color: '#14b8a6', description: 'Mejora la calidad del sistema.' },
  catalogador: { name: 'Catalogador', icon: '📁', iconKey: 'BadgeTrustedIcon', color: '#06b6d4', description: 'Aporta estructura al catálogo.' },
  motor_de_red_v2: { name: 'Motor de Red', icon: '⚙️', iconKey: 'BadgeImpactHighIcon', color: '#ec4899', description: 'Genera movimiento en la red.' },
  conector: { name: 'Conector', icon: '🔗', iconKey: 'BadgeActiveIcon', color: '#8b5cf6', description: 'Une a la comunidad.' },
  impacto_alto: { name: 'Impacto Alto', icon: '💥', iconKey: 'BadgeImpactHighIcon', color: '#ef4444', description: 'Genera valor masivo en la red.' },
  partner_friendly: { name: 'Partner Friendly', icon: '🏪', iconKey: 'BadgeCollectorHubFriendlyIcon', color: '#10b981', description: 'Usuario activo en circuito Partner.' },
  level_coleccionista: { name: 'Coleccionista', icon: '📚', iconKey: 'UserLevelCollectorIcon', color: '#3b82f6', description: 'Alcanzo nivel Coleccionista.' },
  level_intercambiador: { name: 'Intercambiador', icon: '🤝', iconKey: 'UserLevelTraderIcon', color: '#8b5cf6', description: 'Alcanzo nivel Intercambiador.' },
  level_referente: { name: 'Referente', icon: '⭐', iconKey: 'UserLevelReferentIcon', color: '#f59e0b', description: 'Alcanzo nivel Referente.' },
}
...
export const REWARD_TYPES = {
  plus_days: { name: 'Dias Plus', icon: '💎', description: 'Acceso temporal a Plus.' },
  pro_days: { name: 'Dias Pro', icon: '👑', description: 'Acceso temporal a Pro.' },
  extend_plus: { name: 'Extender Plus', icon: '💎+', description: 'Mas tiempo en Plus.' },
  extend_pro: { name: 'Extender Pro', icon: '👑+', description: 'Mas tiempo en Pro.' },
  upgrade_pro_temp: { name: 'Upgrade temporal', icon: '⬆️', description: 'Sube temporalmente a Pro.' },
  extra_favorites: { name: 'Favoritos extra', icon: '❤️', description: 'Mayor capacidad util temporal.' },
  boost_visibility: { name: 'Ventana de visibilidad', icon: '🚀', description: 'Mejor exposicion temporal en resultados.' },
  priority_trades: { name: 'Prioridad contextual', icon: '🎯', description: 'Prioridad en contextos relevantes de cruce.' },
  premium_alerts: { name: 'Alertas premium', icon: '🔔', description: 'Alertas de alta oportunidad.' },
  advanced_suggestions: { name: 'Sugerencias avanzadas', icon: '🧭', description: 'Mejores sugerencias para cerrar cruces.' },
  special_badge: { name: 'Distintivo util', icon: '🏅', description: 'Insignia con efecto de confianza o visibilidad.' },
  early_access: { name: 'Acceso anticipado', icon: '🕐', description: 'Acceso temprano a funciones nuevas.' },
  // V2 Rewards
  community_boost: { name: 'Boost comunitario', icon: '🌍', description: 'Mejor visibilidad en la comunidad.' },
  profile_visibility_plus: { name: 'Visibilidad perfil+', icon: '👤+', description: 'Tu perfil resalta en listados.' },
  featured_badge_reward: { name: 'Badge destacado', icon: '✨', description: 'Badge con brillo especial.' },
  editorial_priority: { name: 'Prioridad editorial', icon: '✍️', description: 'Tus sugerencias se revisan antes.' },
  now_exposure: { name: 'Exposición en "Ahora"', icon: '📺', description: 'Apareces en el feed de actividad real.' },
  temporal_highlight: { name: 'Highlight temporal', icon: '🔦', description: 'Resaltado visual en el mapa y listas.' },
  suggested_favorite: { name: 'Favorito sugerido', icon: '⭐+', description: 'Apareces como sugerencia de seguimiento.' },
  curator_mark: { name: 'Marca de curador', icon: '🎨', description: 'Sello de calidad en tus aportes.' },
}
