...
export default function AdminRoles() {
  ...
  const roles = [
    { value: 'user', label: 'Usuario Estándar', color: "var(--admin-muted2)" },
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ textAlign: 'left', borderBottom: '2px solid #f1f5f9' }}>
                ...
                <th style={{ padding: '1rem', fontSize: '0.75rem', fontWeight: 800, color: "var(--admin-muted2)", textTransform: 'uppercase' }}>Acción</th>
              </tr>
            </thead>
            <tbody>
