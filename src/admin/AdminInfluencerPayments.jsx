...
export default function AdminInfluencerPayments() {
  const { payments, affiliates, fetchPayments, fetchInfluencers, createPayment, updatePayment, loading } = useInfluencerStore()
  ...
  useEffect(() => { fetchPayments(); fetchInfluencers() }, [])
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div>
                  ...
                  <input style={inputStyle} value={form.payment_method} onChange={e => setForm({ ...form, payment_method: e.target.value })} placeholder="Transferencia, PayPal, etc." />
                </div>
                <div>
