      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '2rem' }}>
        <form onSubmit={handleSave} style={card}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: "var(--admin-muted2)", marginBottom: '0.375rem', textTransform: 'uppercase' }}>Título del Sitio (Default)</label>
              <input 
                type="text" 
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: "var(--admin-muted2)", marginBottom: '0.375rem', textTransform: 'uppercase' }}>Meta Descripción (Global)</label>
              <textarea 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div style={{ ...card, background: "var(--admin-panel2)", borderColor: "var(--admin-muted)" }}>
            <h3 style={{ fontSize: '0.9375rem', fontWeight: 800, marginBottom: '1rem', color: "var(--admin-line)" }}>Visualización en Google</h3>
