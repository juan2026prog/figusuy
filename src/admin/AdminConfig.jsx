        ...
        <div style={card}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: '0.8125rem', color: "var(--admin-muted2)", marginTop: '0.25rem' }}>Bloquea el acceso a toda la plataforma.</p>
            </div>
            <button 
              ...
              style={{ 
                ...
                background: settings.maintenance_mode ? '#ef4444' : "var(--admin-line)", transition: 'all 0.2s'
              }}
            >
              <div style={{ width: '1.25rem', height: '1.25rem', background: "var(--admin-panel2)", borderRadius: '50%', position: 'absolute', top: '0.25rem', left: settings.maintenance_mode ? '2rem' : '0.25rem', transition: 'all 0.2s' }} />
            </button>
          </div>
        </div>
        ...
        <div style={{ ...card, gridColumn: 'span 2' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            {[
              ...
              <div key={flag.key} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem', background: "var(--admin-panel2)", borderRadius: '0.75rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <span className="material-symbols-outlined" style={{ color: "var(--admin-muted2)" }}>{flag.icon}</span>
                ...
                <button 
                  ...
                  style={{ 
                    ...
                    background: settings[flag.key] ? 'var(--color-primary)' : "var(--admin-muted)", transition: 'all 0.2s'
                  }}
                >
                  <div style={{ width: '1.1rem', height: '1.1rem', background: "var(--admin-panel2)", borderRadius: '50%', position: 'absolute', top: '0.2rem', left: settings[flag.key] ? '1.7rem' : '0.2rem', transition: 'all 0.2s' }} />
                </button>
              </div>
            ))}
          </div>
