...
export default function BusinessPending() {
  ...
  return (
    <div className="flex-center" style={{ minHeight: '100vh', padding: '1rem', backgroundColor: '#020617', color: 'white' }}>
      <div style={{ maxWidth: '400px', width: '100%', backgroundColor: '#0f172a', padding: '3rem 2rem', borderRadius: '1.5rem', border: '1px solid #1e293b', textAlign: 'center' }}>
        ...
        <p style={{ color: '#94a3b8', fontSize: '0.9375rem', marginBottom: '2rem', lineHeight: 1.5 }}>
        ...
        <button 
          ...
          style={{ width: '100%', padding: '0.875rem', backgroundColor: '#ea580c', color: 'white', fontWeight: 900, borderRadius: '1rem', border: 'none', cursor: 'pointer' }}
        >
          Volver al Perfil
        </button>
      </div>
